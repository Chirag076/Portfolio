...
const About = () => {
    ...
    const handleScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          setShowShapes(window.scrollY > 300);
          ticking = false;
        });
        ticking = true;
      }
  ...
  const shapes = useMemo(() => {
    return isMobile
      ? [
          { x: -10, y: 60, size: 250, src: "/images/heart.png", delay: 0 },
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap justify-center mt-8 z-10 space-x-4 lg:space-x-8">
        <a
          href="#contact"
          className="relative inline-block text-base lg:text-xl font-extrabold uppercase text-white px-6 lg:px-10 py-3 lg:py-4 rounded-full
             -translate-y-1 transition-all duration-500 ease-out border-[3px] lg:border-[4px] border-transparent overflow-hidden
             hover:-translate-x-[4px] lg:hover:-translate-x-[6px] hover:translate-y-[6px] lg:hover:translate-y-[8px]
             hover:rotate-[-2deg] lg:hover:rotate-[-2deg]
             hover:shadow-[8px_8px_25px_rgba(190,100,255,0.8)] lg:hover:shadow-[12px_12px_40px_rgba(190,100,255,0.8)]
             hover:border-white"
        >
        ...
        <a
          ...
          className="relative inline-block text-base lg:text-xl font-extrabold uppercase text-white px-6 lg:px-10 py-3 lg:py-4 rounded-full
             ...
             hover:-translate-x-[4px] lg:hover:-translate-x-[6px] hover:translate-y-[6px] lg:hover:translate-y-[8px]
             hover:rotate-[2deg] lg:hover:rotate-[2deg]
             hover:shadow-[8px_8px_25px_rgba(255,150,100,0.8)] lg:hover:shadow-[12px_12px_40px_rgba(255,150,100,0.8)]
             hover:border-white"
        >
